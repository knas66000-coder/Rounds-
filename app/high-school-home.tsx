    ...
    <ScreenContainer className="px-5" edges={["top", "left", "right"]}>
      <FlatList
        ...
        ListHeaderComponent={<View style={styles.header}>
          <Pressable onPress={() => { haptic.light(); router.push("/high-school-portal" as never); }} accessibilityRole="button"><Text style={[styles.portalBack, { color: colors.primary }]}>‹ High School portal</Text></Pressable>
          ...
          <View style={styles.actionRow}>
            <QuickAction colors={colors} primary label="Manage offline subjects" onPress={() => { haptic.light(); router.push({ pathname: "/course-packs", params: { level, portal: "high_school" } } as never); }} />
            <QuickAction colors={colors} label="Study profile" onPress={() => { haptic.light(); router.push({ pathname: "/academic-onboarding", params: { portal: "high_school" } } as never); }} />
          </View>
