...
function ProtectedNavigator() {
  ...
  return <Stack screenOptions={{ headerShown: false }}><Stack.Screen name="(tabs)" /><Stack.Screen name="academic-onboarding" /><Stack.Screen name="academic-home" /><Stack.Screen name="owner-control" /><Stack.Screen name="research-updates" /><Stack.Screen name="mock-exam" /><Stack.Screen name="oral-exam" /><Stack.Screen name="voice-tutor" /><Stack.Screen name="study-materials" /><Stack.Screen name="pdf-reader" /><Stack.Screen name="adaptive-review" /><Stack.Screen name="exam-remediation" /><Stack.Screen name="bookmark-review" /><Stack.Screen name="notifications" /><Stack.Screen name="oauth/callback" /></Stack>;
}
