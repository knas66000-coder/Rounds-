...
const styles = StyleSheet.create({
  content: { paddingTop: 18, paddingBottom: 34, gap: 18 },
  header: { gap: 4 },
  eyebrow: { fontSize: 10, letterSpacing: 1.7, fontWeight: "900" },
  title: { fontFamily: "Georgia", fontSize: 30, lineHeight: 37, fontWeight: "700" },
  institution: { fontSize: 14, fontWeight: "700" },
  programCard: { borderRadius: 25, padding: 19, gap: 7 },
  programLabel: { fontSize: 10, letterSpacing: 1.4, fontWeight: "900", opacity: 0.82 },
  programTitle: { fontFamily: "Georgia", fontSize: 25, lineHeight: 31, fontWeight: "700" },
  programText: { fontSize: 13, lineHeight: 19, opacity: 0.9 },
  readyPill: { alignSelf: "flex-start", borderRadius: 999, paddingHorizontal: 10, paddingVertical: 7, marginTop: 5 },
  readyText: { fontSize: 9, letterSpacing: 1, fontWeight: "900" },
  actionGroup: { gap: 9 },
  sectionLabel: { fontSize: 10, letterSpacing: 1.5, fontWeight: "900" },
  primaryButton: { minHeight: 56, borderRadius: 18, paddingHorizontal: 18, flexDirection: "row", alignItems: "center", justifyContent: "space-between" },
  primaryText: { fontSize: 16, fontWeight: "900" },
  primaryArrow: { fontSize: 29, fontWeight: "300" },
  secondaryRow: { flexDirection: "row", gap: 10 },
  smallAction: { minHeight: 79, flex: 1, borderWidth: 1, borderRadius: 18, padding: 13, justifyContent: "center", gap: 4 },
  smallActionLabel: { fontSize: 9, letterSpacing: 1.1, fontWeight: "900" },
  smallActionText: { fontSize: 14, lineHeight: 18, fontWeight: "900" },
  nursingRow: { borderWidth: 1, borderRadius: 20, padding: 15, flexDirection: "row", alignItems: "center", justifyContent: "space-between", gap: 12 },
  nursingLabel: { fontSize: 9, letterSpacing: 1.2, fontWeight: "900" },
  nursingText: { fontSize: 13, lineHeight: 18, fontWeight: "800", marginTop: 3, maxWidth: 195 },
  oralButton: { borderWidth: 1, borderRadius: 13, minHeight: 38, paddingHorizontal: 12, justifyContent: "center" },
  oralButtonText: { fontSize: 12, fontWeight: "900" },
  infoRow: { borderWidth: 1, borderRadius: 20, padding: 16, gap: 5 },
  infoTitle: { fontSize: 15, fontWeight: "900" },
  infoText: { fontSize: 13, lineHeight: 19 },
  profileButton: { minHeight: 47, paddingHorizontal: 4, flexDirection: "row", justifyContent: "space-between", alignItems: "center" },
  profileButtonText: { fontSize: 13, fontWeight: "800" },
  profileChevron: { fontSize: 26, fontWeight: "300" },
