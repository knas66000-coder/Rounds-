...
export const OWNER_CONTROL_PACKS = [
  ...
  { id: "uganda-high-school", title: "Uganda High School", status: "active", detail: "Active local core and specialist packs for Biology, Chemistry, Physics, Mathematics, English, Economics, Entrepreneurship, Geography, History and Civics, ICT, Agriculture, Religious and Ethical Studies, Kiswahili, Literature, Fine Art, and Technical Drawing; each includes private learning cases and offline installation." },
] as const;
