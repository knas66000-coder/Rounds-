...
export const OWNER_CONTROL_PACKS = [
  ...
  { id: "uganda-high-school", title: "Uganda High School", status: "active", detail: "Active local core, specialist, and practical packs for Biology, Chemistry, Physics, Mathematics, English, Economics, Entrepreneurship, Geography, History and Civics, ICT, Agriculture, Religious and Ethical Studies, Kiswahili, Literature, Fine Art, Technical Drawing, Food and Nutrition, Music, and Physical Education; each includes private learning cases and offline installation." },
] as const;
