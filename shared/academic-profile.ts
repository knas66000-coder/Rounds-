export const ACADEMIC_PROGRAMS = [
  ...
  { id: "uganda_high_school_kiswahili", title: "High School Kiswahili", faculty: "Uganda High School", packTitle: "Kiswahili learning pack", description: "Original starter practice in reading, vocabulary in context, respectful communication, and clear Kiswahili expression for Ugandan high-school learners.", available: true },
  { id: "uganda_high_school_literature", title: "High School Literature", faculty: "Uganda High School", packTitle: "Literature learning pack", description: "Original starter practice in close reading, themes, character evidence, interpretation, and creative response for Ugandan high-school learners.", available: true },
  { id: "uganda_high_school_fine_art", title: "High School Fine Art", faculty: "Uganda High School", packTitle: "Fine art learning pack", description: "Original starter practice in visual observation, design choices, respectful critique, and reflective creative process for Ugandan high-school learners.", available: true },
  { id: "uganda_high_school_technical_drawing", title: "High School Technical Drawing", faculty: "Uganda High School", packTitle: "Technical drawing learning pack", description: "Original starter practice in visual communication, scale, drawing conventions, constraints, and careful technical reasoning for Ugandan high-school learners.", available: true },
  { id: "uganda_high_school_food_nutrition", title: "High School Food and Nutrition", faculty: "Uganda High School", packTitle: "Food and nutrition learning pack", description: "Original starter practice in records, food information, planning, careful comparison, and responsible classroom reasoning for Ugandan high-school learners.", available: true },
  { id: "uganda_high_school_music", title: "High School Music", faculty: "Uganda High School", packTitle: "Music learning pack", description: "Original starter practice in listening, pattern, performance planning, and respectful musical response for Ugandan high-school learners.", available: true },
  { id: "uganda_high_school_physical_education", title: "High School Physical Education", faculty: "Uganda High School", packTitle: "Physical education learning pack", description: "Original starter practice in movement planning, fair participation, observation, and reflection for Ugandan high-school learners.", available: true },
] as const;
